...
local hls_highlight = utils.get_color_from_var(vim.g.apprentice_hls_highlight, bg4,
                                               colors)
...
local tabline_sel = utils.get_color_from_var(vim.g.apprentice_tabline_sel, green, colors)
...
local base_group = lush(function()
  return {
    ...
    LineNr {fg = bg3, bg = number_column},
    CursorLineNr {fg = aqua, bg = bg1},
    MatchParen {bg = yellow, gui = styles.bold},
    ModeMsg {ApprenticeGreenBold},
    MoreMsg {fg = colors.neutral_green, gui = styles.bold},
    NonText {ApprenticeBg2},
    Normal {fg = fg2, bg = background},
    Pmenu {fg = fg2, bg = bg2},
    PmenuSel {fg = bg2, bg = colors.neutral_aqua, gui = styles.bold},
    PmenuSbar {bg = bg2},
    PmenuThumb {fg = colors.neutral_aqua, bg = neutral_aqua},
    Question {ApprenticeGreenBold},
    QuickFixLine {fg = bg0, bg = aqua, gui = styles.bold},
    ...
    Define {fg = colors.neutral_aqua},
    Macro {fg = colors.neutral_aqua},
    PreCondit {fg = colors.neutral_aqua},
    Type {ApprenticePurple},
    StorageClass {ApprenticePurple},
    Structure {ApprenticePurple},
    Typedef {ApprenticePurple},
    SpecialChar {fg = colors.neutral_aqua},
    Tag {fg = colors.neutral_aqua, gui = styles.bold},
    Delimiter {Special},
